...
@XmlType(name = "GaFlightProductDescriptionInfo", propOrder = {
...
public class GaFlightProductDescriptionInfo  {

    private static final long serialVersionUID = 1L;

    public GaFlightProductDescriptionInfo(
        String flightPackageTagIcon, 
        String flightPackageTag, 
        GaFlightPackageType flightPagkageType, 
        boolean isBundle, 
        ...
        List<ProductExchangeInfo> productExchangeInfos, 
        int boundledCount, 
        ...
        this.boundledCount = boundledCount;
    ...
    private GaFlightPackageType flightPagkageType;
    ...
    private ProductExchangeInfo productExchangeInfo;
    ...
    @FieldDoc("国内往返捆绑的优惠券，如果两程都有，要计数")
    @JsonProperty("BoundledCount")
    @XmlElement(name = "BoundledCount")
    private int boundledCount;
     ...
     * 国内打包产品类型
     */
    public GaFlightPackageType getFlightPagkageType() {
        return this.flightPagkageType;
    }

    public void setFlightPagkageType(GaFlightPackageType flightPagkageType) {
        this.flightPagkageType = flightPagkageType;
    }
     ...
     */
    public ProductExchangeInfo getProductExchangeInfo() {
        return this.productExchangeInfo;
    }

    public void setProductExchangeInfo(ProductExchangeInfo productExchangeInfo) {
        this.productExchangeInfo = productExchangeInfo;
    }
    ...
    public void setProductExchangeInfos(List<ProductExchangeInfo> productExchangeInfos) {
        this.productExchangeInfos = productExchangeInfos;
    }

    /**
     * 国内往返捆绑的优惠券，如果两程都有，要计数
     */
    public int getBoundledCount() {
        return this.boundledCount;
    }

    public void setBoundledCount(int boundledCount) {
        this.boundledCount = boundledCount;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final GaFlightProductDescriptionInfo other = (GaFlightProductDescriptionInfo)obj;
        return
            ...
            Objects.equal(this.boundledCount, other.boundledCount) && 
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(this.boundledCount);
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
            ...
            .add("boundledCount", boundledCount)

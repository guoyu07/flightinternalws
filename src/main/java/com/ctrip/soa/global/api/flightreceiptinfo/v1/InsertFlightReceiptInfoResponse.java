...
@XmlRootElement(name = "InsertFlightReceiptInfoResponse", namespace = "http://soa.ctrip.com/Global/API/FlightReceiptInfo/v1")
@XmlType(name = "InsertFlightReceiptInfoResponse", propOrder = {
    "responseStatus",
    "operationResult",
    "resultMessage",
    "responseHead"
...
public class InsertFlightReceiptInfoResponse implements HasResponseStatus {

    private static final long serialVersionUID = 1L;

    public InsertFlightReceiptInfoResponse(
    ...
    public boolean equals(Object obj) {
        ...
        final InsertFlightReceiptInfoResponse other = (InsertFlightReceiptInfoResponse)obj;
        return

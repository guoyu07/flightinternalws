...
@XmlType(name = "GaSubmitFlightOrderRequestPayInfo", propOrder = {
    "cardInfoID",
    "cardTypeID",
    "payType",
...
public class GaSubmitFlightOrderRequestPayInfo  {

    private static final long serialVersionUID = 1L;

    public GaSubmitFlightOrderRequestPayInfo(
        int cardInfoID, 
        int cardTypeID, 
        String payType, 
    ...
    public boolean equals(Object obj) {
        ...
        final GaSubmitFlightOrderRequestPayInfo other = (GaSubmitFlightOrderRequestPayInfo)obj;
        return

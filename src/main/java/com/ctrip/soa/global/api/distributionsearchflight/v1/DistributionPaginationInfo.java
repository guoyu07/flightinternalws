...
@XmlType(name = "DistributionPaginationInfo", propOrder = {
    "pageIndex",
    "itemCount",
    "resultPageCount"
})
@SuppressWarnings("all")
public class DistributionPaginationInfo  {

    private static final long serialVersionUID = 1L;

    public DistributionPaginationInfo(
        Integer pageIndex, 
        Integer itemCount, 
    ...
    public boolean equals(Object obj) {
        ...
        final DistributionPaginationInfo other = (DistributionPaginationInfo)obj;
        return

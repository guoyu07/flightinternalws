...
@XmlRootElement(name = "GetSeoPopularFlightInfoRequest", namespace = "http://soa.ctrip.com/Global/API/GetSeoPopularFlightInfo/v1")
@XmlType(name = "GetSeoPopularFlightInfoRequest", propOrder = {
    "head",
    "dCityCode",
    "aCityCode"
})
@SuppressWarnings("all")
public class GetSeoPopularFlightInfoRequest  {

    private static final long serialVersionUID = 1L;

    public GetSeoPopularFlightInfoRequest(
        Head head, 
        String dCityCode, 
        String aCityCode) {
        this.head = head;
    ...
    public boolean equals(Object obj) {
        ...
        final GetSeoPopularFlightInfoRequest other = (GetSeoPopularFlightInfoRequest)obj;
        return

...
@XmlType(name = "DistributionTerminalInfo", propOrder = {
    "id",
    "code",
    "name",
    "enName",
...
public class DistributionTerminalInfo  {

    private static final long serialVersionUID = 1L;

    public DistributionTerminalInfo(
        int id, 
        String code, 
        String name, 
        String enName, 
    ...
    public boolean equals(Object obj) {
        ...
        final DistributionTerminalInfo other = (DistributionTerminalInfo)obj;
        return

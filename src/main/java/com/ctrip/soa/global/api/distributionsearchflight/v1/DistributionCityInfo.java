...
@XmlType(name = "DistributionCityInfo", propOrder = {
    "id",
    "code",
    "name",
    "enName"
...
public class DistributionCityInfo  {

    private static final long serialVersionUID = 1L;

    public DistributionCityInfo(
        int id, 
        String code, 
        String name, 
        String enName) {
    ...
    public boolean equals(Object obj) {
        ...
        final DistributionCityInfo other = (DistributionCityInfo)obj;
        return

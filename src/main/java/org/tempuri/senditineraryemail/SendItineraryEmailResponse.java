...
@XmlRootElement(name = "SendItineraryEmailResponse", namespace = "http://tempuri.org/SendItineraryEmail.xsd")
@XmlType(name = "SendItineraryEmailResponse", propOrder = {
    "responseStatus",
    "responseHead",
    "result"
})
@SuppressWarnings("all")
public class SendItineraryEmailResponse implements HasResponseStatus {

    private static final long serialVersionUID = 1L;

    public SendItineraryEmailResponse(
    ...
    public boolean equals(Object obj) {
        ...
        final SendItineraryEmailResponse other = (SendItineraryEmailResponse)obj;
        return
